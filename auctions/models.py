...
class Listing(models.Model):
    ...
    comments = models.ManyToManyField(Comment, related_name="listing_comments", blank=True)
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name="user_listings")
    winner = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, related_name="user_winning_listings")
